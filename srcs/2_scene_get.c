...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/06 14:11:00 by jwisozk           #+#    #+#             */
/*   Updated: 2019/12/06 14:11:00 by jwisozk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					int *block, int *i)
{
	...
	{
		if (*i == CAMERA)
			ft_camera_create(data, *lst);
		else if (*i == LIGHT)
			ft_light_create(data, *lst);
		else if (*i > LIGHT && *i < COUNT)
			ft_obj_create(data, *lst);
